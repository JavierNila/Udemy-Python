...
# Evitar maximizar - (en la nueva version de Tkinter se pone (False, False) en lugar de (0, 0)
...
# Lista de productos
lista_comidas = ['pollo', 'tocino', 'pescado', 'molida', 'res', 'pizza', 'burrito', 'carne']
lista_bebidas = ['agua', 'fanta', 'jugo', 'pepsi', 'vino', 'whisky', 'coca', 'volt']
lista_postres = ['helado', 'fruta', 'brownies', 'flan', 'mousse', 'pastel', 'donas', 'carlota']
